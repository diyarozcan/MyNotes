...
namespace Notlarim102.Entity.ValueObject
{
    public class RegisterViewModel
    {
        ...
        [DisplayName("Sifre"), Required(ErrorMessage = "{0} alani bos gecilemez."), DataType(DataType.Password), StringLength(30, ErrorMessage = "{0} max. {1} karakter olmali")]
        public string Password { get; set; }
        [DisplayName("Sifre Tekrar"), Required(ErrorMessage = "{0} alani bos gecilemez."), DataType(DataType.Password), StringLength(30, ErrorMessage = "{0} max. {1} karakter olmali"),Compare("Password",ErrorMessage ="{0} ile {1} uyusmuyor")]
